...
```
python test_tangram -c [camera] -s [side : left | right] -o [output_folder] -m [model] -i [input folder for video (OPTIONAL)]
```

**Example:**

```
python test_tangram.py -c 1 -s left -o result_pics -models\tangram_jason_mobilenet_final_06082020.h5
```
